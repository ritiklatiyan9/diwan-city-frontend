...
const heroStats: { label: string; value: string }[] = [
  { label: "Finance modules", value: "12+" },
        ...
        >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-primary via-primary/60 to-foreground/80 bg-clip-text text-transparent">
              one intelligent ledger
            </span>
          </motion.h1>

          <motion.p
            variants={itemVariants}
            className="mx-auto mb-8 max-w-2xl text-lg text-foreground/70 md:text-xl"
          >
            Manage multi-site finances, plot payments, day books, commissions and
            approvals in one place — with role-based access and real-time insight
          ...
          >
            <Button asChild size="lg" className="h-12 rounded-xl px-6 text-sm font-semibold shadow-lg shadow-primary/20">
              <Link to="/login">
                Get started <ArrowRight className="ml-1.5 h-4 w-4" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="h-12 rounded-xl px-6 text-sm font-semibold">
