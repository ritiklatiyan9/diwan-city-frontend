...
// ─── AnimatedFolder ───
export function AnimatedFolder({ title, projects, className, onClick, isCompact = false }) {
    ...
    <>
      <div
        className={cn(
          ...
          isCompact ? "p-4 rounded-xl" : "p-8 rounded-2xl",
          "cursor-pointer",
          "bg-card border border-border",
        ...
        style={{
          minWidth: isCompact ? "90px" : "280px",
          minHeight: isCompact ? "100px" : "320px",
          perspective: "1000px",
        }}
      ...
      >
        ...
        <div 
          ...
          style={{ 
            height: isCompact ? "60px" : "160px", 
            width: isCompact ? "80px" : "200px",
            scale: isCompact ? "0.45" : "1"
          }}
        >
          {/* Folder back layer */}
          <div
        ...
        <h3
          className={cn(
            isCompact ? "text-xs px-1" : "text-lg",
            "font-semibold text-foreground mt-2 transition-all duration-300 text-center truncate w-full"
          )}
          style={{
